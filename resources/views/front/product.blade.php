                    ...
                    <div class="col-md-3">
                        <div class="single-populer-products">
                            <div class="single-populer-product-img mt40">
                                <img src="{{asset("front/assets/images/populer-products/p1.png")}}" alt="populer-products images">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div class="single-inner-populer-product-img">
                                            <img src="{{asset("front/assets/images/populer-products/p2.png")}}" alt="populer-products images">
                                        </div>
                                    </div>
                        ...
                        <div class="single-populer-products">
                            <div class="single-populer-products">
                                <div class="single-populer-product-img">
                                    <img src="{{asset("front/assets/images/populer-products/p3.png")}}" alt="populer-products images">
                                </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="{{asset("storage/".$product->image)}}" alt="new-arrivals images">
                                ...
                                <div class="new-arrival-cart">
                                    <p>
                                        <span class="lnr lnr-cart"></span>
                                        <a href="{{route("show.product",$product->id)}}">add <span>to </span> cart</a>
                                    </p>
                            ...
                            <h4><a href="{{route("show.product",$product->id)}}">{{$product->name}}</a></h4>
                            <p class="arrival-product-price">@if($product->flag == 1) {{$product->base_price}} @else {{$product->discount_price}} @endif</p>
                        </div>
                    </div>
                        @endforeach
                    @endisset
